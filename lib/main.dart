import 'package:bloc_cubit/bloc/counter_bloc_bloc.dart';
import 'package:bloc_cubit/cubit_counter/counter_cubit.dart';
    ...
    return Scaffold(
      ...
      floatingActionButton: Column(
        ...
        children: [
          FloatingActionButton(
            onPressed: () {
              context.read<CounterBlocBloc>().add(CounterBlocIncrementEvent());
            },
            tooltip: 'Increment',
            child: const Icon(Icons.add),
          ),
          FloatingActionButton(
            onPressed: () {
              context.read<CounterBlocBloc>().add(CounterBlocDecrementEvent());
            },
            tooltip: 'Decrement',
            child: const Icon(Icons.minimize_rounded),
          ),
